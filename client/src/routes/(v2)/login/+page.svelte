<script lang="ts">
    import {Cross1, EnvelopeClosed, LockClosed, Symbol} from "@steeze-ui/radix-icons";
                ...
                <PostPadding>
                    ...
                    <div class="px-2">
                        ...
                        <div class="flex flex-row gap-1 items-center">
                            <button disabled={loading} on:click={login} class="{loadingClass} p-2 px-4 my-4 items-center bg-white text-black hover:opacity-50 transition ease-in-out duration-500">
                                {#if loading}
                        ...
                        <a href="/signup{callback !== null ? '?callback='+encodeURIComponent(callback) : ''}" class="hover:opacity-60 animated duration-700">
                            <p class="text-xs font-light">Don't have an account yet?</p>
                        </a>
                    </div>
                </PostPadding>
            </div>
